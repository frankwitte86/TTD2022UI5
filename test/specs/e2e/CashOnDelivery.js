...
const CheckOutCashOnDelivery = require('../../pageobjects/checkout.cashondelivery');
...
describe('Shopping Cart - Cash On Delivery Flow', () => {
    ...
    it('Verify and Proceed Checkout Page - Account Details', async () => {
        await CheckOutCashOnDelivery.enterTextAccountDetails("Joris", "de Tester", "666", "test@123.nl")
        await CheckOutCashOnDelivery.pressNextStepButton();
    })
    ...
    it('Verify and Proceed Checkout Page - Delivery Type Express', async () => {
